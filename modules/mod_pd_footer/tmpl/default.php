...
<style type="text/css">
	...
	@media(max-width: 990px){
		...
		.total_mobile .body_item_footer{
			display: flex;
    		align-items: center;
    		justify-content: center;
		}
		.cuadro_texto_final_footer{
			text-align: center;
		}
...
<div class="cuadro_gen_footer">
	<div class="container">
		<div class="row">
			<div class="col-sm-12 col-md-6 col-lg-2 columna_footer footer_pr_col">
				...
				<div>
					...
					<a href="<?php echo($pdfooter_logo_url) ?>">
			...
			<?php foreach ($pdfooter_columnas as $key => $columna) { ?>
				<div class="col-6 col-xs-6 col-sm-6 col-md-4 col-lg-<?php echo($columna->ancho_col); ?> columna_footer
					 <?php if($columna->total_mobile){echo('total_mobile');} ?>">
					<div class="titulo_footer">
						<span><?php echo($columna->titulo); ?></span>
					</div>
					<div style="" class="body_item_footer">
		...
		<div class="cuadro_texto_final_footer">
			<?php for($k=0; $k<count($pdfooter_textos_finales['texto']); $k++){ ?>
				...
				<?php } ?>
					...
					<?php if($pdfooter_textos_finales['nl_mobile'][$k]){ ?>
						<br class="nl_mobile">
					<?php } ?>
