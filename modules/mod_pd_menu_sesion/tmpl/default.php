...
<style type="text/css">
	...
	#form_iniciar_sesion select{
		<?php if($menu_sesion_color_select_tipo){ ?>
			color: <?php echo($menu_sesion_color_select_tipo); ?>;
		<?php }else{ ?>
			color: #555;
		<?php } ?>
	}
	...
	<div class="cuadro_flota_sesion cls" id="cuadro_iniciar_sesion">
		<div class="cuadro_sup_sesion cls">
			<div class="titulo_form_is cls">
				<div class="titulo cls"><span class="cls"><?php echo($menu_sesion_titulo); ?></span></div>
				<div class="subtitulo cls">
					<span class="cls"><?php echo($menu_sesion_subtitulo); ?></span>
				</div>
			</div>
			<form id="form_iniciar_sesion" class="cls">
				...
				<input type="text" name="username" data-toggle="tooltip" placeholder="Usuario" 
				title="Debe ingresar el nombre de usuario." class="cls">
				<input type="password" name="password" data-toggle="tooltip" placeholder="Contraseña" 
				title="Debe ingresar una contraseña." class="cls">
			...
			<div style="text-align: center">
				...
				style="<?php if($menu_sesion_color_rec_pass){echo('color: ' . $menu_sesion_color_rec_pass);} ?>">
					<span class="cls">Recuperar contraseña</span>
				</a>				
			</div>
			<div class="btn_reguser_menses">
