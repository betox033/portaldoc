...
$biografia_titulo_direccion_1 = $params['biografia_titulo_direccion_1'];
$biografia_titulo_direccion = $params['biografia_titulo_direccion'];

$valora_color_fondo = $params['valora_color_fondo'];
$valora_color_borde = $params['valora_color_borde'];
$valora_color_texto = $params['valora_color_texto'];
