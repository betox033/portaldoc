		...
		<div class="botones_top_header">
			<?php for($k=0; $k < count($pdtopheader_botones['texto']); $k++){ ?>
				<a href="<?php echo($pdtopheader_botones['url'][$k]); ?>"
					...
					>
					<div class="btn_top_header btn_th__<?php echo($k); ?> <?php echo($pdtopheader_botones['clase'][$k]); ?>">
						<img src="<?php echo($pdtopheader_botones['icono'][$k]); ?>"
						class="<?php echo($pdtopheader_botones['clase'][$k]); ?>">
						<span class="<?php echo($pdtopheader_botones['clase'][$k]); ?>">
							<?php echo($pdtopheader_botones['texto'][$k]); ?></span>
					</div> 					
				</a>
			<?php } ?>
		</div>
