...
<div style="background-color: #ffd6d6; color:red; padding:10px; margin-bottom: 15px;">
	<strong>Se ha registrado una valoración negativa de unos de los usuarios a un perfil médico.</strong>
</div>
...
<div style="padding: 10px; border: 1px solid lightgrey; margin-bottom: 15px;">
	<strong>DATOS DEL MÉDICO VALORADO</strong><br><br>
	<strong>Nombre: </strong><span><?php echo($medico->name . " " . $medico->apellido); ?></span><br>
	<strong>Teléfono: </strong><span><?php echo($medico->telefono); ?></span><br>
	<strong>Email: </strong><span><?php echo($medico->email); ?></span><br>
	<strong>RUT: </strong><span><?php echo($medico->rut); ?></span><br>
	<strong>Especialidad: </strong><span><?php echo($medico->especialidad); ?></span><br>
	<span><?php echo($medico->especialidad_detalle); ?></span>
</div>
